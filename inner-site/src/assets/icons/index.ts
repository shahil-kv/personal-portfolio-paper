...
import shahordleIcon from './shahordleIcon.png';
import notepadIcon from './notepadIcon.png';
import windowNotepadIcon from './windowNotepadIcon.png';
...
const icons = {
    ...
    windowNotepadIcon: windowNotepadIcon,
    scrabbleIcon: scrabbleIcon,
    shahordleIcon: shahordleIcon,
    close: close,
