        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            ...
                            <p>SKBIOS (C)2000 Shahil KV Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>SKP S13 2000-2026 Special UC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>SKP Showcase(tm) XX 113</p>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Shahil KV Portfolio Showcase 2026</p>
                    <br />
                    <p>
                        This site is built for a <b>desktop or laptop</b>. It
                        is not fully responsive on mobile yet.
                    </p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                                <p style={styles.warning}>
                                    WARNING: You're on a small screen - for the
                                </p>
                                <p style={styles.warning}>
                                    full experience, open it on a computer.
                                </p>
                            </b>
                        </>
                    )}
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                        <p>Click START below to begin{'\xa0'}</p>
                        <span className="blinking-cursor" />
                    </div>
                    <div
                        style={{
